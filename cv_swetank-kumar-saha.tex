...
\item Identify oppurtunities \& challenges in realizing 802.11ad indoor WLANs
...
\cvlistitem{LTE/WiFi coexistence in 5 GHz \textsc{[P1]}
\begin{itemize}
\renewcommand\labelitemi{--}
...
\cvitemwithcomment{}{Medium Access and Transport Protocol Aspects in Practical 802.11ad Networks}{IEEE WoWMoM 2018}
\cvitemwithcomment{}{Performance Characterization of COTS 802.11ad Devices}{}
...
\cvitem{Web Chair}{
\begin{itemize}
\item ACM International Conference on Embedded Wireless Systems and Networks (EWSN) 2018
...
\cvitem{\textit{Linux}}{Wireless Device Drivers (\textsc{ath9k, ath10k, wil6210}), TCP and MPTCP Netwoking Subsystem/Stack}
\cvitem{\textit{Cloud}}{Google App Engine}
\cvitem{\textit{Web}}{Django, PHP, HTML, js}


\section{Personal}
\cvitem{Residence}{USA, F1 Visa}
