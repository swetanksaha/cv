...
\begin{itemize}
  ...
  \item Published 1 top-tier conference paper \hyperref[C4]{[C4]}
\end{itemize}
}
...
\begin{itemize}
  ...
  \item Published 1 top-tier conference paper \hyperref[C1]{[C1]}
\end{itemize}
}
...
\begin{itemize}
  ...
  \item Developed an auto-grader as a distributed application that fully automates the entire grading pipeline
  \item PA 1: Text Chat \& File Transfer Application \link[\faExternalLink]{https://cse4589.github.io/pa1/} (Source: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa1}), PA 2: Reliable Transport Protocols \link[\faExternalLink]{https://cse4589.github.io/pa2/} (Source: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa2}), PA 3: Software Defined Routing \link[\faExternalLink]{https://cse4589.github.io/pa3/} (Source: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa3}, (Sample code: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa3/blob/master/SampleCode/swetankk/src/control_header_lib.c}))
        %\begin{itemize}
  ...
  %\item PA 2: Reliable Transport Protocols \link[\faExternalLink]{https://cse4589.github.io/pa2/} (Source: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa2})
        %\begin{itemize}
        %  \item Implementation of three reliable data transport protocols: Alternating bit, Go-Back-N \& Selective repeat%, and multiple alarms with a single simulator timer
        %\end{itemize}
  %\item PA 3: Software Defined Routing \link[\faExternalLink]{https://cse4589.github.io/pa3/} (Source: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa3}, (Sample code: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa3/blob/master/SampleCode/swetankk/src/control_header_lib.c}))
        %\begin{itemize}
        %  \item Implementation of a simplified version of the distance vector routing protocol, introducing the concept of control and data planes and construction of raw packets akin to Linux kernel (Sample code: \link[\faGithub]{https://github.com/swetanksaha/cse4589-pa3/blob/master/SampleCode/swetankk/src/control_header_lib.c})
        %\end{itemize}
\end{itemize}
}
