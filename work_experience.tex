...
\vspace{0.025in}
\begin{itemize}
  \item Designed DeMiLTE, the first WiFi (802.11ac)-based mechanism for enterprise APs to detect, quantify, and react to LTE-U/LAA interference in real time, without 
