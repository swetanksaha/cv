...
requiring additional AP hardware
  \item Implemented this mechanism inside the AP firmware making it light-weight and eliminating the need for client modifications
...
\begin{itemize}
  ...
  \item Modified the Linux 802.11ad wireless driver \texttt{(wil6210)} to export PHY/MAC information to userspace and allow user control over PHY parameters, like beam direction \link[\faGithub]{https://github.com/swetanksaha/wil6210}
