...
\texttt{OpenThread}\newline
\texttt{TCP/IP}\newline
}{Wireless Connectivity Performance Engineer}{\textbf{Apple Inc.}}{Cupertino, CA}{US}{
...
\item Developed performance analysis tool to timesync \& correlate performance data generated from fiwmare and host layer logs for easy debugging
...
\item Developed tool that allows analysis of music streaming performance across the networking stack  
\item Working with FW and Host teams for low latency audio peformance measurements and improvements
\end{itemize}
}
