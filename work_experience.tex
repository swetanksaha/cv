\cventry{\textit{November 2019--Present}\newline
\texttt{Python}\newline
\texttt{Drivers}\newline
\texttt{Firmware}\newline
\texttt{TCP/IP}\newline
}{Wireless Connectivity Performance Engineer}{\textbf{Apple Inc.}}{Cupertino, CA}{US}{
\underline{Analyze the connectivity sub-system and identify solutions for improving end-to-end performance}
\vspace{0.025in}
\begin{itemize}
\item Devising performance evaluation methodologies on SW/HW prototypes to guide final design
\item Responsible for defining the Key Performance Indicators (KPIs)
\item Developing tools and techniques for measuring KPIs under different stressors
\item Data analysis to identify areas for connectivity performance enhancement
\item Propose and prototype new algorithms/solutions and lead cross-functional to commercialization
\item Current focus on improving peer-to-peer wireless performance and co-existence with other co-located wireless interfaces 
\end{itemize}
}
