...
\begin{itemize}
  ...
  \item Developed systems for WiFi APs to detect, quantify and react to LTE interference in real time, without extra hardware.
  \item Implemented DeMiLTE inside the AP firmware making it light-weight and not requiring client modifications.
