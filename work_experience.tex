\cventry{\centering \textit{Nov. 2019 -- Current}\newline
\texttt{802.11}\newline
\texttt{Python}\newline
\texttt{Firmware}\newline
\texttt{OpenThread}\newline
\texttt{TCP/IP}\newline
}{Software Development Enginner - Test (WiFi Performance)}{\textbf{Apple Inc.}}{Cupertino, CA}{US}{
\underline{Evaluating \& Improving wireless connectivity performance}
\vspace{0.025in}
\begin{itemize}
\item Characterize and identify the optimal design choices for improving the wireless system performance on Apple devices and platforms
\item Devise and build evaluation methodologies for benchmarking wireless performance of prorotypes, under different scnearios and stressors
\item Analyze logs/data from multiple sub-systems (Application/TCP/IP/MAC/PHY), using tools and protocl analyzers, to identify areas of sub-optimal performance
\item Define targets for critical WiFi performance metrics and lead cross-functional efforts to ensure targets are being met until commercialization
\item Design and develop software, scripts and tools to analyze wireless performance data (using Python, Shell etc.)
\end{itemize}
}

\cventry{\textit{Sep. -- Nov. \newline 2019}\newline
\texttt{802.11ad}\newline
}{Unpaid Intern}{\textbf{State University of New York at Buffalo}}{Buffalo, NY}{US}{
\underline{Introduction to Programming Languages}
\vspace{0.025in}
\begin{itemize}
  \item Performed measurements to evaluate the performance of the IEEE 802.11ad wireless standard in indoor environments
  \item Processed and Analyzed collected measurement data to identify scenarios where wireless link performance is sub-optimal
  \item Prepared and submitted a Journal paper reporting the findings (published in IEEE TMC 2021)
\end{itemize}
}

\cventry{\textit{Summer 2019}\newline
\texttt{Programming Languages}\newline
}{Course Instructor}{\textbf{State University of New York at Buffalo}}{Buffalo, NY}{US}{
\underline{Introduction to Programming Languages}
\vspace{0.025in}
\begin{itemize}
  \item Course Instructor for introductory course on Programming Languages, focusing on functional programming
  \item Design and develop course material, assignments and exams
\end{itemize}
}
...
\cventry{\textit{2013--2019}}{Research Assistant (RA) | Teaching Assistant (TA)}{\textbf{University at Buffalo}, SUNY}{NY}{US}{}
