...
\texttt{OpenThread}\newline
\texttt{TCP/IP}\newline
}{WiFi Performance Engineer}{\textbf{Apple Inc.}}{Cupertino, CA}{US}{
\underline{Evaluating \& Improving wireless connectivity performance of next-generation technologies and devices}
\vspace{0.025in}
\begin{itemize}
\item Devise metrics/methodologies and develop the tools and techniques for wireless performance evaluation
\item Analyze data to identify areas for enhancement, prototype new solutions and guide them to commercialization
\item Designed and built a traffic emulator to generate realistic Thread traffic patterns, measure performance and report critical metrics; In use by several cross-functional teams
\item Developed a tool to timesync \& correlate performance data generated from host and network chipset
\item Built entire setup from scratch to evaluate wireless P2P performance both standalone and under co-existence with other co-channel technologies, uncovered areas with sub-optimal performance \& proposed improvements
\item Developed a framework that allows analysis of music streaming performance across the networking stack
\end{itemize}
}
