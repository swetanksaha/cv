\cventry{\textit{Nov. 2019--Present}\newline
\texttt{Python}\newline
\texttt{Firmware}\newline
\texttt{802.11}\newline
\texttt{OpenThread}\newline
...
\item Analyze data to identify areas for enhancement, prototype new solutions and lead commercialization
\item Developed a tool to timesync \& correlate performance data generated from host and network chipset
\item Built entire setup from scratch to evaluate wireless peer-to-peer performance both standalone and under co-existence with other co-channel technologies
\item Uncovered several areas where performance can be sub-par and proposed solutions for improvement
\item Developed a framework that allows analysis of music streaming performance across the networking stack
\item Designed and built a traffic emulator to generate realistic Thread traffic patterns, measure performance and report critical metrics; In used by several cross-functional teams.  
\end{itemize}
}
