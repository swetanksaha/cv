...
\begin{itemize}
  ...
  \item Enabled WiFi APs to detect, quantify and react to LTE interference in real time, without extra hardware.
  \item Implemented DeMiLTE inside the AP firmware making it light-weight and not requiring client modifications.
  \item Evaluated DeMiLTE showing it improves AP downlink throughput by up to \textbf{110\%} in a real network.
